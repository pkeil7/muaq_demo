...
def main() -> None:
    ...
    st.markdown(
        """
        <div style="position: fixed; right: 16px; bottom: 16px; z-index: 900; max-width: 290px; padding: 6px 10px; border: 1px solid #d8dbe2; border-radius: 8px; font-size: 0.78rem; line-height: 1.25; ">
